...
document.addEventListener("DOMContentLoaded",()=>{
    ...
    try {
        ...
        document.querySelectorAll(".item-box").forEach(el => {
            addedItemList.push(parseInt(el.dataset.itemid));
            console.log(el.dataset.itemid);
            console.log(typeof (el.dataset.itemid));
            console.log(el.dataset.itemid.length);
        })
        console.log("itemIds");
...
document.querySelector("#add").onclick = function (){
    ...
    console.log(t);
    addedItemList.push(parseInt(document.querySelector("#itemID").value));
    let id;
    let data = {};
    let dataDisplay = {};
    ...
    document.querySelectorAll(".bin").forEach(btn=>{
        btn.onclick = function (){
            ...
            if(confirm("Do you really want to Delete this Order ?")){
                ...
                fetch(`/orderInventory/OrderDeleteItems/`,{
                    method:"POST",
                    headers: {
    ...
    data.forEach(div=>{
            ...
            if(key == "id"){
                ...
                updateField.innerHTML += `<div class="form-element-box">
                                    ...
                                    <div class="form-control">
                                        <input type="number" required class="from-element" name='${tempId}' id=${key} placeholder="Requeied ${key} in KG ">
                                    </div>
                                </div>`;
            }
        }
...
function updateAvelableItem(){
    document.querySelectorAll(".suggetion-list-item p").forEach(p=>{
